...
export interface SessionStore {
  create(session: PortalSession): Promise<string>
  read(sessionId: string): Promise<PortalSession | null>
  replace(sessionId: string, session: PortalSession): Promise<void>
