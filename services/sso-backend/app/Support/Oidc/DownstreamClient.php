...
final readonly class DownstreamClient
{
     ...
     * component. Shared well-formedness (fragment, double-encoding, traversal,
     * scheme/host) lives in RedirectUriWellFormedness; here HTTP is permitted for
     * localhost development only.
     */
    private static function isWellFormedRedirectUri(string $uri): bool
    {
        return RedirectUriWellFormedness::isWellFormed($uri, allowLocalhostHttp: true);
    }
