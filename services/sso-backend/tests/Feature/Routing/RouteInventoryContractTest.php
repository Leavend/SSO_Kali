...
it('keeps the production route inventory intentional', function (): void {
    ...
    expect($routes)->toHaveCount(139);
    expect(applicationRoutes($routes))->toHaveCount(127);
...
function expectedApplicationRouteSignatures(): array
{
    return collect([
        ...
        'GET|HEAD admin/api/audit/retention',
        ...
        'POST admin/api/client-integrations',
        ...
        'GET|HEAD admin/api/compliance/evidence-pack',
        ...
        'POST admin/api/users/{subjectId}/require-mfa',
        'POST admin/api/users/{subjectId}/reset-mfa',
        'POST admin/api/users/{subjectId}/sync-profile',
        'POST admin/api/users/{subjectId}/unrequire-mfa',
