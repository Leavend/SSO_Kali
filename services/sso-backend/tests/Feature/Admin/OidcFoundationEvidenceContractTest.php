...
it('returns safe OIDC foundation evidence for authorized admins', function (): void {
    ...
    $response
        ...
        ->assertJsonPath('evidence.jwks_rotation.status', 'recorded')
        ->assertJsonPath('evidence.jwks_rotation.evidence_ref', 'docs/ops/evidence/jwks-rotation-2026-05-30.md')
        ->assertJsonPath('evidence.jwks_rotation.operator_signoff', 'Leavend')
        ->assertJsonPath('evidence.jwks_rotation.environment', 'staging')
