/**
 * Barrel export — atoms layer (design.md §3.1).
 *
 * Atoms = komponen terkecil tanpa dependensi ke molecule/organism.
 */

export { default as AppBrandMark } from './AppBrandMark.vue'
export { default as SsoAuroraSvg } from './SsoAuroraSvg.vue'
export { default as SsoAuthLockup } from './SsoAuthLockup.vue'
...
export { default as SsoPhotoBackground } from './SsoPhotoBackground.vue'
