...
router.beforeEach(async (to) => {
	...
	if (to.meta.requiresGuest) {
		...
		// Jangan hit session endpoint dari halaman guest. Browser menampilkan 401
		// sebagai console error meski aplikasi menanganinya, dan itu mengganggu
		// LCP/debugging production. Redirect guest hanya jika state lokal sudah
		// tahu user authenticated.
