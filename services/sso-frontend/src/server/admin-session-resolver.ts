...
export async function resolveAdminSession(request: IncomingMessage): Promise<ResolvedAdminSession | null> {
...
export function sessionHeaders(resolved: ResolvedAdminSession): Record<string, readonly string[]> {
