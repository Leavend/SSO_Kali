...
require_text "docker-compose.dev.yml" 'image: sso-dev-sso-admin-frontend:\$\{APP_IMAGE_TAG:-local\}' "Vue canary image is tag-addressable"
...
require_text "docker-compose.dev.yml" 'traefik.http.routers.sso-admin-frontend.priority=175' "Vue canary priority stays below backend"
