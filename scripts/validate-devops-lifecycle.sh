...
require_text "scripts/vps-deploy.sh" 'prevent Compose dollar interpolation' "Deploy blocks raw dollar-interpolated App B secret hashes"
...
require_text "scripts/vps-rollback.sh" 'prevent Compose dollar interpolation' "Rollback blocks raw dollar-interpolated App B secret hashes"
