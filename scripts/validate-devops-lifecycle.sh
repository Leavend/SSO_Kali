...
require_text "docker-compose.dev.yml" 'Host\(`\$\{SSO_ADMIN_DOMAIN:-admin.timeh.my.id\}`\)' "Admin frontend route uses dedicated host"
...
require_text ".env.dev.example" '^SSO_ADMIN_DOMAIN=admin.timeh.my.id$' "Development env example exposes admin frontend domain"
