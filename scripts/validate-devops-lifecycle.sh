...
require_text "services/sso-frontend/src/web/styles/auth-shell-floating.css" 'position: relative' "Vue auth shell toggle uses in-flow floating host"
require_text "services/sso-frontend/src/web/styles/auth-shell-floating.css" 'min-height: 40px' "Vue auth shell toggle reserves clickable floating rail"
require_text "services/sso-frontend/src/web/styles/auth-shell-floating.css" 'transform: none' "Vue auth shell toggle stays visible inside stacked UI"
require_text "infra/zitadel-login/patch-login-floating-toggle.mjs" 'position: relative' "Hosted login toggle uses in-flow floating host instead of viewport-fixed placement"
