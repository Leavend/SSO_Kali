...
has_text "docker-compose.dev.yml" 'traefik.http.routers.sso-admin-frontend.rule=Host(`${SSO_ADMIN_DOMAIN:-admin-sso.timeh.my.id}`)' "Admin frontend uses dedicated host route"
